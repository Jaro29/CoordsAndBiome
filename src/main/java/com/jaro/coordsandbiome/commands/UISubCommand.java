...
import com.jaro.coordsandbiome.ui.CoordsAndBiomeDashboardUI;

import javax.annotation.Nonnull;

/**
 * /coo ui - Open the plugin dashboard UI
 *
...
public class UISubCommand extends AbstractPlayerCommand {
    ...
    protected void execute(
        ...
        context.sendMessage(Message.raw("Opening CoordsAndBiome Dashboard..."));
        ...
        try {
            ...
            CoordsAndBiomeDashboardUI dashboardPage = new CoordsAndBiomeDashboardUI(playerRef);
