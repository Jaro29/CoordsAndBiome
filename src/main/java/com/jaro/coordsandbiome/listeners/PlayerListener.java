package com.jaro.coordsandbiome.listeners;
...
public class PlayerListener {
    ...
    public void register(EventRegistry eventBus) {
        ...
        try {
            ...
            LOGGER.at(Level.INFO).log("[CoordsAndBiome] Registered PlayerConnectEvent listener");
        } catch (Exception e) {
            LOGGER.at(Level.WARNING).withCause(e).log("[CoordsAndBiome] Failed to register PlayerConnectEvent");
        }

        // PlayerDisconnectEvent - When a player disconnects
        try {
            eventBus.register(PlayerDisconnectEvent.class, this::onPlayerDisconnect);
            LOGGER.at(Level.INFO).log("[CoordsAndBiome] Registered PlayerDisconnectEvent listener");
        } catch (Exception e) {
            LOGGER.at(Level.WARNING).withCause(e).log("[CoordsAndBiome] Failed to register PlayerDisconnectEvent");
        }
    }
    ...
    private void onPlayerConnect(PlayerConnectEvent event) {
        ...
        LOGGER.at(Level.INFO).log("[CoordsAndBiome] Player %s connected to world %s", playerName, worldName);
    ...
    private void onPlayerDisconnect(PlayerDisconnectEvent event) {
        ...
        LOGGER.at(Level.INFO).log("[CoordsAndBiome] Player %s disconnected", playerName);
