...
/**
 * CoordsAndBiome Dashboard UI
 *
 * A simple interactive dashboard page showing plugin information
 * with refresh and close buttons.
 */
public class CoordsAndBiomeDashboardUI extends InteractiveCustomUIPage<CoordsAndBiomeDashboardUI.UIEventData> {

    // Path relative to Common/UI/Custom/
    public static final String LAYOUT = "coordsandbiome/Dashboard.ui";

    private final PlayerRef playerRef;
    private int refreshCount = 0;

    public CoordsAndBiomeDashboardUI(@Nonnull PlayerRef playerRef) {
